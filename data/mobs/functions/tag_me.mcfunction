...
execute at @s if entity @a[scores={dimentions=2}, distance=..120] unless entity @s[tag=one_time] if entity @s[type=#tags:h_overw] run function mobs:o2/tag_me

execute if entity @s[type=warden] run function mobs:warden/tag_me
execute if entity @s[type=wither] run function mobs:wither/tag_me
