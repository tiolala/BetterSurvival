...
execute if entity @s[type=#tags:ht1] run function mobs:n3/supersize_me
execute if entity @s[type=#tags:ht2] run function mobs:n3/supersize_me
execute if entity @s[type=#tags:ht3] run function mobs:n3/supersize_me
