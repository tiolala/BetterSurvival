...
execute as @e[tag=spider_web, tag=o3] at @s positioned ~-0.5 ~-1 ~-0.5 run effect give @e[dx=0, dy=1, dz=0] minecraft:mining_fatigue 2 9

scoreboard players add @e[tag=spider_web] index 1
kill @e[tag=spider_web, tag=!o3, scores={index=8..}]
