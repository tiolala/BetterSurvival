...
scoreboard objectives remove exp_shovel
scoreboard objectives remove exp_hoe
...
scoreboard objectives remove lvl_pickaxe
scoreboard objectives remove lvl_shovel
scoreboard objectives remove lvl_hoe
