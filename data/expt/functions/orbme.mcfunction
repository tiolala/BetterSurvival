...
#swords
execute if entity @s[nbt={SelectedItem:{id:"minecraft:wooden_sword"}}] run function expt:orb_sword
...
#others
execute if entity @s[nbt={SelectedItem:{id:"minecraft:trident"}}] run function expt:orb_trident

execute if entity @s[nbt={SelectedItem:{id:"minecraft:bow"}}] run function expt:orb_bow

execute if entity @s[nbt={SelectedItem:{id:"minecraft:crossbow"}}] run function expt:orb_crossbow
