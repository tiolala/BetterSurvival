...
execute if score @s lvl_sword matches 3 if score @s exp_sword >= level3 exp_sword run function expt:sword/lvl_up
execute if score @s lvl_sword matches 4 if score @s exp_sword >= level4 exp_sword run function expt:sword/lvl_up
execute if score @s lvl_sword matches 5 if score @s exp_sword >= level5 exp_sword run function expt:sword/lvl_up
execute if score @s lvl_sword matches 6 if score @s exp_sword >= level6 exp_sword run function expt:sword/lvl_up
execute if score @s lvl_sword matches 7 if score @s exp_sword >= level7 exp_sword run function expt:sword/lvl_up
execute if score @s lvl_sword matches 8 if score @s exp_sword >= level8 exp_sword run function expt:sword/lvl_up
execute if score @s lvl_sword matches 9 if score @s exp_sword >= level9 exp_sword run function expt:sword/lvl_up

execute if score @s lvl_axe matches 1 if score @s exp_axe >= level1 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 2 if score @s exp_axe >= level2 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 3 if score @s exp_axe >= level3 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 4 if score @s exp_axe >= level4 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 5 if score @s exp_axe >= level5 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 6 if score @s exp_axe >= level6 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 7 if score @s exp_axe >= level7 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 8 if score @s exp_axe >= level8 exp_axe run function expt:axe/lvl_up
execute if score @s lvl_axe matches 9 if score @s exp_axe >= level9 exp_axe run function expt:axe/lvl_up

execute if score @s lvl_crossbow matches 1 if score @s exp_crossbow >= level1 exp_crossbow run function expt:crossbow/lvl_up
execute if score @s lvl_crossbow matches 2 if score @s exp_crossbow >= level2 exp_crossbow run function expt:crossbow/lvl_up
execute if score @s lvl_crossbow matches 3 if score @s exp_crossbow >= level3 exp_crossbow run function expt:crossbow/lvl_up
execute if score @s lvl_crossbow matches 4 if score @s exp_crossbow >= level4 exp_crossbow run function expt:crossbow/lvl_up
execute if score @s lvl_crossbow matches 5 if score @s exp_crossbow >= level5 exp_crossbow run function expt:crossbow/lvl_up
execute if score @s lvl_crossbow matches 6 if score @s exp_crossbow >= level6 exp_crossbow run function expt:crossbow/lvl_up
execute if score @s lvl_crossbow matches 7 if score @s exp_crossbow >= level7 exp_crossbow run function expt:crossbow/lvl_up
...
execute if score @s lvl_trident matches 4 if score @s exp_trident >= level4 exp_trident run function expt:trident/lvl_up
execute if score @s lvl_trident matches 5 if score @s exp_trident >= level5 exp_trident run function expt:trident/lvl_up
execute if score @s lvl_trident matches 6 if score @s exp_trident >= level6 exp_trident run function expt:trident/lvl_up
execute if score @s lvl_trident matches 7 if score @s exp_trident >= level7 exp_trident run function expt:trident/lvl_up
