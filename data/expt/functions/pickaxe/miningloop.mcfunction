...
execute at @e[tag=mine_here,tag=!old] positioned ~1 ~ ~ unless entity @e[tag=mine_here,distance=..0.5] if block ~ ~ ~ #expt:ores run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["mine_here","new"]}
execute at @e[tag=mine_here,tag=!old] positioned ~-1 ~ ~ unless entity @e[tag=mine_here,distance=..0.5] if block ~ ~ ~ #expt:ores run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["mine_here","new"]}
execute at @e[tag=mine_here,tag=!old] positioned ~ ~1 ~ unless entity @e[tag=mine_here,distance=..0.5] if block ~ ~ ~ #expt:ores run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["mine_here","new"]}
execute at @e[tag=mine_here,tag=!old] positioned ~ ~-1 ~ unless entity @e[tag=mine_here,distance=..0.5] if block ~ ~ ~ #expt:ores run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["mine_here","new"]}
execute at @e[tag=mine_here,tag=!old] positioned ~ ~ ~1 unless entity @e[tag=mine_here,distance=..0.5] if block ~ ~ ~ #expt:ores run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["mine_here","new"]}
