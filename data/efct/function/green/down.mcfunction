...
execute if block ~ ~ ~ minecraft:short_grass run function efct:green/tallgrass_here
execute if block ~ ~ ~ minecraft:grass_block run setblock ~ ~1 ~ minecraft:short_grass
