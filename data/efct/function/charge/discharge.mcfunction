...
execute at @s as @e[type=#tags:all,distance=0.01..1] run function efct:charge/me
...
execute at @s as @e[type=#tags:all,distance=0.01..2] run function efct:charge/me
execute at @s as @e[type=player,distance=0.01..2] run function efct:charge/me
execute at @s as @e[type=#tags:all,distance=0.01..2] run function efct:charge/me
execute at @s as @e[type=player,distance=0.01..2] run function efct:charge/me

execute at @s as @e[type=#tags:all,distance=0.01..4] run function efct:charge/me
execute at @s as @e[type=player,distance=0.01..4] run function efct:charge/me

execute at @s as @e[type=#tags:all,distance=0.01..8] run function efct:charge/me
