...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"dark_purple","italic":false,"text":"Large Water Magic"}'],"minecraft:custom_data":{gems:["blue","gemed","3"]},"minecraft:enchantment_glint_override":true}}}
