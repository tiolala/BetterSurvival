...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"dark_purple","italic":false,"text":"Small Unbreaking Magic"}'],"minecraft:custom_data":{gems:["gray","gemed","1"]},"minecraft:enchantment_glint_override":true}}}
