...
tag @s add ttag01
kill @e[type=arrow,distance=..12]
execute as @e[type=#mobs:passive,distance=..12] at @s run function gems:white/carrot/push_me
execute as @e[type=#mobs:neutral,distance=..12] at @s run function gems:white/carrot/push_me
execute as @e[type=#mobs:ht1,distance=..12] at @s run function gems:white/carrot/push_me
execute as @e[type=#mobs:ht2,distance=..8] at @s run function gems:white/carrot/push_me
execute as @e[type=#mobs:ht3,distance=..4] at @s run function gems:white/carrot/push_me
