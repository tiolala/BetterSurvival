...
execute as @e[type=#tags:passive,distance=..12] at @s run function gems:white/carrot/push_me
execute as @e[type=#tags:neutral,distance=..12] at @s run function gems:white/carrot/push_me
execute as @e[type=#tags:ht1,distance=..12] at @s run function gems:white/carrot/push_me
execute as @e[type=#tags:ht2,distance=..8] at @s run function gems:white/carrot/push_me
execute as @e[type=#tags:ht3,distance=..4] at @s run function gems:white/carrot/push_me
