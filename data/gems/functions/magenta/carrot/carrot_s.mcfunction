#gems:magenta/carrot/carrot_s

tag @e[tag=unfinished] remove unfinished
execute anchored eyes run summon minecraft:marker ^ ^ ^2.5 {Tags:["unfinished","gem_magenta", "wandshot"]}
...
execute if score @s wandmana matches 4.. run scoreboard players remove @s wandmana 4
