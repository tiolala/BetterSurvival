...
execute unless entity @e[tag=ttag01] as @e[distance=..6,scores={hurttime=1..10},limit=1,sort=nearest] at @s as @e[type=#tags:all,distance=..4] run function efct:freeze/me
