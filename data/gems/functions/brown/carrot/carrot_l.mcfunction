#gems:brown/carrot/carrot_l

tag @e[tag=unfinished] remove unfinished
execute anchored eyes run summon minecraft:marker ^ ^ ^3 {Tags:["unfinished","gem_brown", "wandshot"]}
execute anchored eyes positioned ^ ^ ^3 run data modify entity @e[type=minecraft:marker,tag=gem_brown,tag=unfinished,limit=1,sort=nearest] Rotation set from entity @s Rotation
