...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"blue","italic":false,"text":"Boss Plant Magic"}'],"minecraft:custom_data":{gems:["green","gemed","4"]},"minecraft:enchantment_glint_override":true}}}
