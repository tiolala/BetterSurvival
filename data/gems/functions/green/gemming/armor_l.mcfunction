...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"dark_purple","italic":false,"text":"Large Plant Magic"}'],"minecraft:custom_data":{gems:["green","gemed","3"]},"minecraft:enchantment_glint_override":true}}}
