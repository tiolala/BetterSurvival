...
execute anchored eyes run summon minecraft:marker ^ ^ ^3 {Tags:["unfinished","gem_black", "wandshot"]}
execute anchored eyes positioned ^ ^ ^3 run data modify entity @e[type=minecraft:marker,tag=gem_black,tag=unfinished,limit=1,sort=nearest] Rotation set from entity @s Rotation
