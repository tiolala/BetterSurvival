...
summon minecraft:marker ~ ~ ~ {Tags:["unfinished","bowshot","purple"]}
...
execute unless score bowPploop flag matches 1 run function gems:purple/bow/loop