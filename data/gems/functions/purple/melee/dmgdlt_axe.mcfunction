...
execute anchored eyes positioned ^ ^ ^2 positioned ~ ~-1 ~ as @e[distance=..2.5,scores={hurttime=10},limit=1,sort=nearest] at @s run function gems:purple/melee/push_alway
