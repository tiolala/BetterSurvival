...
execute store result entity @s Motion[0] double 0.0015 run scoreboard players get @e[tag=ttag02,limit=1] xcord
execute store result entity @s Motion[1] double 0.0015 run scoreboard players get @e[tag=ttag02,limit=1] ycord
execute store result entity @s Motion[2] double 0.0015 run scoreboard players get @e[tag=ttag02,limit=1] zcord
