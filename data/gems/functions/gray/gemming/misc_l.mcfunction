...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"dark_purple","italic":false,"text":"Large Unbreaking Magic"}'],"minecraft:custom_data":{gems:["gray","gemed","3"]},"minecraft:enchantment_glint_override":true}}}
