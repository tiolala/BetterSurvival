...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"blue","italic":false,"text":"Medium Unbreaking Magic"}'],"minecraft:custom_data":{gems:["gray","gemed","2"]},"minecraft:enchantment_glint_override":true}}}
