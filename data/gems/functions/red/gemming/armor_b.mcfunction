...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"blue","italic":false,"text":"Boss Lava Magic"}'],"minecraft:custom_data":{gems:["red","gemed","4"]},"minecraft:enchantment_glint_override":true}}}
