...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"blue","italic":false,"text":"Small Lava Magic"}'],"minecraft:custom_data":{gems:["red","gemed","1"]},"minecraft:enchantment_glint_override":true}}}
