...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"dark_purple","italic":false,"text":"Large Lava Magic"}'],"minecraft:custom_data":{gems:["red","gemed","3"]},"minecraft:enchantment_glint_override":true}}}
