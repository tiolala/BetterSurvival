...
data merge entity @s {Item:{components:{"minecraft:lore":['{"color":"blue","italic":false,"text":"Medium Lava Magic"}'],"minecraft:custom_data":{gems:["red","gemed","2"]},"minecraft:enchantment_glint_override":true}}}
