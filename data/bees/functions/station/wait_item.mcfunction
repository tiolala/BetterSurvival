...
execute if entity @s[tag=waiting] if entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:golden_sword",Count:1b}}] run function bees:station/change2_atk
execute if entity @s[tag=waiting] if entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:carved_pumpkin",Count:1b}}] run function bees:station/change2_scarecrow
