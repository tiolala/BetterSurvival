...
execute as @e[type=bee,tag=unfinished,tag=working_bee] store result score @s idunico run scoreboard players get @e[tag=bee_station,limit=1,sort=nearest] idunico

execute as @e[type=bee,tag=unfinished,tag=working_bee] run tag @s remove unfinished

scoreboard players set @s state 0
execute as @e[tag=station_aux] if score @s idunico = @e[tag=bee_station,limit=1,sort=nearest] idunico run tp @s ~ ~1.4 ~
execute as @e[tag=station_aux] if score @s idunico = @e[tag=bee_station,limit=1,sort=nearest] idunico run tag @s remove inlog
execute as @e[tag=station_aux] if score @s idunico = @e[tag=bee_station,limit=1,sort=nearest] idunico run tag @s remove inblock
execute as @e[tag=station_aux] if score @s idunico = @e[tag=bee_station,limit=1,sort=nearest] idunico run tag @s remove intarget
execute as @e[tag=station_aux] if score @s idunico = @e[tag=bee_station,limit=1,sort=nearest] idunico run tag @s remove near_bee
